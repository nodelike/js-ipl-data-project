...
async function getMatchesPerYear(request, response){
  ...
  try {
    ...
    return response.status(200).send(matchesInYear);
  } catch (error){
...
async function getMatchesWonPerTeamPerYear(request, response){
  ...
  try {
    ...
    return response.status(200).send(wins);
  } catch (error) {
...
async function calculateExtraRunsPerTeam(request, response){
    try {
      ...
      return response.status(200).send(extraRunsPerTeam);
    } catch (error) {
...
async function calculateBowlersEconomyRate(request, response){
    try {
      ...
      return response.status(200).send(economyRates);
    } catch (error) {
...
async function getHighestPlayerOfMatchForEachSeason(request, response){
    try {
      ...
      return response.status(200).send(highestPlayerOfMatchPerSeason);
    } catch (error) {
...
async function getBatsmanStrikeRateBySeason(request, response){
    try {
      ...
      return response.status(200).send(batsmanStrikeRateBySeason);
    } catch (error) {
...
async function getBestEconomicalRateInSuperOverBowler(request, response){
    try {
      ...
      return response.status(200).send(bestEconomyRatePlayer);
    } catch (error) {
